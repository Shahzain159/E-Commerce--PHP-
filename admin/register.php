...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $query="INSERT INTO admin VALUES (NULL,'$name','$email','$contact','$pass1')";
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-reg-image"><img src="./img/register.jpg" width="500"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" name="contact" class="form-control form-control-user" placeholder="Contact: e.g 03XX-1234567">
                                </div>
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="password" name="checkpassword" class="form-control form-control-user" placeholder="Repeat Password">
                                    </div>
                                </div>
